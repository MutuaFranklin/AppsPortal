    ...
    <div class="bg-body d-flex flex-center rounded-4 w-md-600px p-10">
        ...
        <div class="w-md-400px w-lg-600px">
            ...
            <div class="text-center mb-11">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder mb-3">My Profile</h1>
                <!--end::Title-->
                <!--begin::Subtitle-->
            ...
            <!--begin::Heading-->
            <!--begin::Form-->
            <form class="form" action="{{route('updateProfile')}}" method="POST" novalidate="novalidate" enctype="multipart/form-data" id="kt_modal_create_status_form">
                <!--begin::Step 1-->
                <div class="current" data-kt-stepper-element="content">
                    <div class="w-lg-450 w-xl-450 row">
                        <div class="fv-row mb-10 d-flex flex-column align-items-center">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                ...
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{auth()->user()->dp_url?auth()->user()->dp_url: asset('/assets/media/uploads/user_images/blank_user.png')}})"></div>
                        ...
                        <div class="fv-row mb-10 col-lg-4">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-lg form-control-solid" name="first_name" placeholder="" value="{{Auth::user()->first_name}}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-10 col-lg-4">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-lg form-control-solid" name="middle_name" placeholder="" value="{{Auth::user()->middle_name}}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-10 col-lg-4">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-lg form-control-solid" name="last_name" placeholder="" value="{{Auth::user()->last_name}}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="fv-row mb-10">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="email" class="form-control form-control-lg form-control-solid" name="email" placeholder="" value="{{Auth::user()->email}}" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                    ...
                    <div class="fv-row mb-10">
                        <!--begin::Label-->
                        <label class="d-flex align-items-center fs-5 fw-bold mb-2">
                            <span class="required">Update Password</span>
